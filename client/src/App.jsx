...
function App() {
  ...
  return (
    <div className='bg-[#343541] h-screen py-6 relative sm:px-16v px-12 text-white overflow-hidden flex flex-col justify-between align-middle'>
      ...
      {/* header */}
      <div className='font-bold text-2xl text-center mb-3'>ChatGPT</div>
